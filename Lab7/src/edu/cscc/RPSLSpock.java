...
public class RPSLSpock {
     ...
     * @param pick
     * @return boolean
     * This method checks to see if the 'pick' is null, it then returns an answer depending on if it is null or not.
     */
     ...
     *
     * @return String
     * This method uses a random number generator to pick the answer
     */
     ...
     * @param h_pick
     * @return boolean
     * This method returns whether or not the player won
     */
